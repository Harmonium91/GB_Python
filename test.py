...
town = input("Введите название вашего города: ")
population = int(input("Введите население ващего города: "))
print(f"В вашем городе {town} проживает {population} жителей!")
...
result = (x + int(str(x) + str(x)) + int(str(x) + str(x) + str(x)))
